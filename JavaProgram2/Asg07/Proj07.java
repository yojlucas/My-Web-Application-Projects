...
This version defaults to scope = "1". Thus:

The code will follow and process all hyperlinks to
 files that are linked to the root file (ITSE2321.htm) in the
 same directory as the root file and in sub-directories of
 that directory. It will ignore all other hyperlinks.

The following comments apply to the program named WebCrawler01. It has been broken into two parts and renamed Proj07/Proj07Runner
to accommodate Asg07.
...
public static void main(String[] argv){
  Proj07Runner runner = new Proj07Runner();
  runner.run(argv);
}//end main method
//==================================================================================//
