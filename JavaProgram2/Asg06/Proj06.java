...
This version defaults to scope = "3"
As such, it will ignore all hyperlinks except those
that have a document-relative path and will also ignore those
with a document-relative path to a sub-directory.

The following comments apply to the program named WebCrawler01. It has been broken into two parts and renamed Proj06/Proj06Runner
...
public static void main(String[] argv){
  Proj06Runner runner = new Proj06Runner();
  runner.run(argv);
}//end main method
//==================================================================================//
